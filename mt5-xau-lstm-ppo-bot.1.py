    ...
    for i in range(SEQ_LEN, len(df)):
        ...
        if save_counter % save_count == 0:
            ...
            if len(trade_returns) > 5:
                ...
                print(f"Weekly PnL:      {weekly_pnl/10:.0f} pips")
                print(f"Winrate:         {winrate*100:.2f}%")
                print(f"Mean Win:        {mean_win/10:.0f} pips")
                print(f"Mean Loss:       {mean_loss/10:.0f} pips")
