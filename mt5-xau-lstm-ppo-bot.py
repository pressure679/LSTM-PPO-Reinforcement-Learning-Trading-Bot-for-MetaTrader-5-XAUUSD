    ...
    for i in range(lookback, len(df)):
        ...
        for j in range(max(0, i - lookback), i):
            ...
            for k in range(j + 1, i):
                ...
                if (
                    # df["bullish_mss"].iloc[k] == 1 and
                    df["Close"].iloc[k] > ob_high
                ):
                    broken = True
                    break
    ...
    for i in range(lookback, len(df)):
        ...
        for j in range(max(0, i - lookback), i):
            ...
            for k in range(j + 1, i):
                ...
                if (
                    # df["bearish_mss"].iloc[k] == 1 and
                    df["Close"].iloc[k] < ob_low
                ):
                    broken = True
                    break
